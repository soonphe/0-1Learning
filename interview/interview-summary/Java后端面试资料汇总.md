...
### 要点
    0.java基础
    1.Spring和SpringBoot和SpringCloud
    2.JVM
    4.设计模式
    5.数据结构
    6.多线程和锁
...
- Q：1万并发量和1万qps有什区别
- A：举个例子，10000个请求并发抵达，服务端有能力同时处理，那就是10000并发（正在处理）。如果每个请求它都能之花0.5秒处理完，那它1秒内一共处理了20000个请求，叫20000 rps（对应的qps也是类似概念，但是不是request，是query）
